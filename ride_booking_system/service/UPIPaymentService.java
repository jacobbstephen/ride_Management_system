...
public class UPIPaymentService implements PayementService {
	@Override
	public boolean makePayment(Ride ride) throws PaymentException {
		...
		System.out.println("Please pay via UPI  Rs." + ride.getFare() + " to " + ride.getDriver().getName() + " for the ride");
		ride.setMethodOfPayment("UPI");
